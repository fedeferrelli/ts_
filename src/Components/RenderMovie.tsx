...
function RenderMovie({movieToShow} : Prop) {
    ...
    return (
        ...
        <div key={id} className="w-full m-auto sm:w-[300px] border bg-slate-800/20 border-slate-600 rounded-[6px] shadow-lg mb-8 relative overflow-hidden hover:shadow-black/50 ease-in-out duration-300" onClick={()=>handleOnClickToShowOverview()}>
